...
public class UsuarioController implements IUsuarioController {
    ...
    public String login(String username, String contrasena) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Usuario usuario
                        = new Usuario(username, contrasena, nombre, apellidos, email, direccion, telefono, saldo, premium);
    ...
    public String register(String username, String contrasena, String nombre, String apellidos, String email,
            String direccion, int telefono, double saldo, boolean premium) {

        Gson gson = new Gson();

        DBConnection con = new DBConnection();
        String sql = "Insert into usuario values('" + username + "', '" + contrasena + "', '" + nombre
                + "', '" + apellidos + "', '" + email + "', '" + direccion + "', " + telefono + ", " + saldo + ", " + premium + ")";

        try {
            Statement st = con.getConnection().createStatement();
            st.executeUpdate(sql);

            Usuario usuario = new Usuario(username, contrasena, nombre, apellidos, email, direccion, telefono, saldo, premium);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Usuario usuario = new Usuario(username, contrasena,
                        nombre, apellidos, email, direccion, telefono, saldo, premium);
    ...
    @Override
    public String modificar(String username, String nuevaContrasena, String nuevoNombre, String nuevosApellidos, String nuevoEmail, String nuevoDireccion, int nuevoTelefono, double nuevoSaldo, boolean nuevoPremium) {

        DBConnection con = new DBConnection();

        String sql = "Update usuario set contrasena = '" + nuevaContrasena + "', nombre = '" + nuevoNombre + "', " + "apellidos = '" + nuevosApellidos + "', email = '" + nuevoEmail + "', direccion = '" + nuevoEmail + "', telefono = " + nuevoTelefono + "', saldo = " + nuevoSaldo + ", premium = ";
        ...
        System.out.println("Estoy modificando usuario");
        return "false";
    ...
    public String verCopias(String username) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                copias.put(id, 0); // copias.put(id, num_copias);
            } 
